...
class Solution{
  public:
    vector <int> verticalSum(Node *root) {
        ...
        map<int, int> verticalSumMap;
        
        // Utility function to perform vertical traversal
        function<void(Node*, int)> verticalTraversal = [&](Node* node, int level) {
        ...
        // Extract vertical sums from the map into a vector
        vector<int> verticalSums;
        for (auto& pair : verticalSumMap) {
            verticalSums.push_back(pair.second);
        }
